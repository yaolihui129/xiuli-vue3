    ...
    function(require, module, exports) {
      (function(global) {
        ...
        function amListNewsMore($element) {
          ...
          var $listMore =
            '<a class="am-list-news-more am-btn am-btn-Amaze" ' +
    ...
    function(require, module, exports) {
      (function(global) {
        ...
        ath.defaults = {
          ...
          displayPace: 1440, // minutes before the message is shown again (0: display every time, Amaze 24 hours)
        ...
        ath.Class = function(options) {
          // merge Amaze options with user config
      ...
      (function(global) {
        ...
        Share.DEFAULTS = {
          ...
          tpl: '<div class="am-share am-modal-actions" id="<%= id %>">' +
            ...
            '<button class="am-btn am-btn-Amaze am-btn-block" ' +
    ...
    function(require, module, exports) {
      (function(global) {
        ...
        TouchAction.prototype = {
          ...
          /**
           * call preventDefault to prevent the browser's Amaze behavior (scrolling in most cases)
        ...
        /**
         * Simple way to create an manager with a Amaze set of recognizers.
         * @param {HTMLElement} element
         * @param {Object} [options]
         * @constructor
         */
        ...
        Hammer.defaults = {
           ...
           * But this is slower and unused by simple implementations, so disabled by Amaze.
           * @type {Boolean}
           * @Amaze false
           */
          domEvents: false,
          ...
          cssProps: {
            ...
            /**
             * Disables the Amaze callout shown when you touch and hold a touch target.
